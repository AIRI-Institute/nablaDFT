...
class GemNetOCNoForcesLightning(pl.LightningModule):
    def __init__(
        self,
        model_name: str,
        net: nn.Module,
        ...
        super(GemNetOCNoForcesLightning, self).__init__()
        self.net = net
    ...
    def step(self, batch, calculate_metrics: bool = False):
        energy_out  = self.net(batch)
        preds = {"energy": energy_out}
        target = {"energy": batch.y}
...
class GemNetOCLightning(pl.LightningModule):
    def __init__(
        self,
        model_name: str,
        net: nn.Module,
