...
convention_dict = {
    ...
    'psi4': Namespace(
        atom_to_orbitals_map={'H': 'ssp', 'O': 'sssppd', 'C': 'sssppd', 
        'N': 'sssppd', 'F': 'sssppd', 'S': 'sssspppd', 'Cl': 'sssspppd',
        'Br': 'sssssppppddd'},
        orbital_idx_map={'s': [0], 'p': [2, 0, 1], 'd': [4, 2, 0, 1, 3]},
        orbital_sign_map={'s': [1], 'p': [1, 1, 1], 'd': [1, 1, 1, 1, 1]},
        orbital_order_map={'H': [0, 1, 2], 'O': [0, 1, 2, 3, 4, 5], 
        'C': [0, 1, 2, 3, 4, 5], 'N': [0, 1, 2, 3, 4, 5], 'F': [0, 1, 2, 3, 4, 5],
        'S': [0, 1, 2, 3, 4, 5, 6, 7], 'Cl': [0, 1, 2, 3, 4, 5, 6, 7],
